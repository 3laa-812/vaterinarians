...
export default function EditProductPage() {
  ...
  if (fetching) {
    return (
      <div className="flex flex-col h-full bg-background relative max-w-4xl mx-auto w-full items-center justify-center">
  ...
  return (
    <div className="flex flex-col h-full bg-background relative max-w-4xl mx-auto w-full">
      <div className="flex-none pt-4 px-4 sm:pt-6 sm:px-6">
        <PageHeader title={t("editProduct") || "Edit Product"} />
      </div>
              ...
              <FormField label={t("productImage")}>
                <label className="relative flex flex-col items-center justify-center w-full min-h-[200px] bg-surface border-2 border-dashed border-outline-variant rounded-xl p-8 text-center transition-colors hover:border-primary cursor-pointer overflow-hidden">
                  ...
                  {uploading ? (
                    ...
                    <img src={imageUrl} alt="Product" className="max-h-48 rounded-lg object-contain" />
                  ) : (
                    <div className="flex flex-col items-center justify-center gap-2">
              ...
              <div className="flex flex-wrap gap-6 pt-2">
                <label className="flex items-center space-x-3 rtl:space-x-reverse cursor-pointer">
                  <div className="relative flex items-center justify-center w-5 h-5">
                    ...
                    />
                    <svg className="absolute w-3.5 h-3.5 text-on-primary pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity" viewBox="0 0 14 14" fill="none">
                ...
                <label className="flex items-center space-x-3 rtl:space-x-reverse cursor-pointer">
                  ...
                  <span className="text-on-surface text-sm">{t("requiresPrescription")}</span>
                </label>
              </div>
